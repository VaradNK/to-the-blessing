    ...
    >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none p-4">
          <div className="bg-black/70 backdrop-blur-sm p-4 sm:p-6 lg:p-8 rounded-xl text-center max-w-md">
            ...
            <p className="text-lg sm:text-xl mb-2 sm:mb-3 font-bold text-white">
              oops...the stars got scattered everywhere🌟🥹
            </p>
            <p className="text-sm sm:text-md mb-2 text-white/90">
              help me baal we have to gather them before they drift away...💫
            </p>
            <p className="text-xs sm:text-sm text-white/70">
              Hint: connect 1️⃣ to 7️⃣...watch the magic happen🪄
            </p>
          </div>
        </div>
      )}
      ...
      <div className="absolute top-2 sm:top-4 left-1/2 z-20 transform -translate-x-1/2 text-center w-full px-4">
        <h1 className={`${isMobile ? 'text-xl' : 'text-3xl'} font-bold text-indigo-100 drop-shadow-lg`}>
          <span className="text-yellow-300">🌌</span> Rutuuu's Space Verse<span className="text-yellow-300">🌌</span>
        </h1>
          ...
          >
            ...
            >
              ...
              <p className="text-sm sm:text-base text-indigo-100">
                and just like that...you've unlocked your first birthday surprise💛
              </p>
            </motion.div>
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-base sm:text-lg text-indigo-100 mt-2">
                    freshly baked in space with love, hugs, & lots of birthday magic🫠
                  </p>
                </div>
              </motion.div>
            </div>
      ...
      >
        <p className="text-indigo-200 text-xs sm:text-sm">
          <span className="block font-medium mb-1">-the answer u wanna know naah why i fell for you...🫠</span>
          1. first thing first ofcourse your eyes!👀<br />
          2. your cute height!🤏😂<br />
          3. your hohoo!🫠<br />
          4. the way you tease me!😼
          5. your smile!😊
          6. simply always...youuu! because you're you & that's more than enough!!!🌻
        </p>
      </motion.div>
