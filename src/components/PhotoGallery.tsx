...
import songA from "./music/enna sona.mp3";
import songB from "./music/main hoon sath tere.mp3";
import songC from "./music/tum se hi.mp3";
...
const photos: Photo[] = [
  {
    url: Pic1,
    caption: "Happy birthday to the ONE whose eyes can make even my worst days feel lighter!!!❤️",
  },
  {
    url: Pic2,
    caption: "Happy birthday to the ONE whose smile deserves a standing ovation every single time!!!🩷",
  },
  {
    url: Pic3,
    caption: "Happy birthday to the ONE who teases me, laughs at me, says hoho, and still manages to be my favorite person!!!🤍",
  },
];

// Playlist song names and corresponding local music files
const playlist = ["Enna Sona!🫠", "Main Hoon Sath Tere!🤗", "Tum Se Hi!🌻"];
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-10">
        ...
        >
          ...
          <div className="relative">
            ...
            >
              If stars had a favorite person...it'd be u dumbo!!!🤍
            </motion.h1>
          ...
          >
            & & &...if i had a chance to fall in love again...I'd still fall for youuu!!!🫠
          </motion.p>
        </motion.div>
              ...
              >
                <h3 className="text-2xl font-bold text-blue-100 mb-5 flex items-center">
                  ...
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-200 to-purple-200">
                    Playlist...secretly dedicated to youuu!!!
                  </span>
                </h3>
                  ...
                  {playlist.map((song, i) => (
                    ...
                    >
                      ...
                      {currentSongIndex === i && (
                        ...
                        >
                          <span className="text-xs mr-1">Melting...</span>
                          <Sparkles size={14} />
                        </motion.div>
                      )}
                    </motion.div>
