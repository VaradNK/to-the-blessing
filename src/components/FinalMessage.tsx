        ...
        >
          <div className="p-8 text-center">
            ...
            <h1 className="text-3xl font-bold text-white mb-4">
              Final Little Adventure✨
            </h1>
            
            <p className="text-indigo-200 mb-8">
              I know you'll win this...unless you're secretly sleepy!!😂 Lead your special 
              starship to shoot {targetScore} of these elements with starbeams, 
              revealing a special birthday message from across the universe just waiting for you rutuuu!!!
            </p>
          ...
          <div className="p-4">
            ...
            <div className="flex justify-between items-center">
              <p className="text-indigo-200 text-center text-sm hidden sm:block">
                Okay birthday girl...time to prove you've got some gaming skills too!✨
              </p>
        ...
        >
          <div className="p-8">
            ...
            <p className="text-indigo-100 leading-relaxed text-center mb-6">
              Dumbooo...If you've made it till here...thank you for going through this little journey I created for youuu...I hope it made you smile at least once cause that's all i wanted!! First of all I just want to wish you the Happiest Birthday!!!🎂 I truly hope this new year of your BAPPA brings you everything you've been praying for...everything you've been working hard for...and everything your heart quietly wishes for!!! May you always stay healthy keep smiling the way you do and never lose that beautiful heart that makes you...youuu!!! Aaaa there's something I also want to say...the past few weeks weren't the best because of me! I know I made BIG mistakes...I know there were moments where I hurt you disappointed you or made you overthink things! I'm genuinely so so so sorry for all of it!!! Rutuuu I can't change what already happened but i can promise you that I've learned from it!! You deserve patience, understanding, honesty, and someone who makes your days lighter instead of heavier!!! I'm trying to become that person every single day...not sympathizing BAPPA promise it's true!!! Thank you for listening to me, for teasing me, for saying your cute "hoho" for making me laugh without even trying, and for simply existing!!! You probably don't realize how many ordinary days became special just because you were a part of them!!! Your eyes...your smile...your height...your kindness...somehow all these became the biggest reasons behind my happiness!!! & there's one thing I think I've already told you enough...but yeah...every single day I quietly pray to BAPPA for one wish—that if YOU allows I get to spend many more birthdays with you!!! I don't know what tomorrow holds and I don't want to make promises I can't control but I do know this falling in love with you has been one of the most beautiful parts of my life and I'm deeply grateful for it!!! If you can find it in your heart to forgive me for the mistakes I've made I promise to keep learning keep growing and keep trying to be that someone who deserves your trust and your smile!!! Thank you for being My Blessing!!!🧿 Once again...HAPPY BIRTHDAY rutuuu!!!🌻 I hope this is only the beginning of countless beautiful birthdays ahead!!! always cheering for your smile!!!🧿
            </p>
