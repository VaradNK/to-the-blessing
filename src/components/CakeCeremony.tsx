...
const AirlockPuzzle = ({ onSolve }) => {
  ...
  const [targetSequence] = useState<number[]>([0, 3, 0, 8]); // The correct sequence
    ...
    >
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-blue-200 mb-1">My Heart's Passcode❤️</h2>
          <p className="text-blue-300/80">only one person knows this code...& that's youuu...blessing!!!</p>
      ...
      >
        <p className="text-sm mb-2 flex items-center justify-center gap-2">
          <Lock size={14} />
          Only rutuuu allowed beyond this point!!🌕
        </p>
        <p className="text-xs">
          once you get it right, something special is waiting...🌻
        </p>
      </motion.div>
    </motion.div>
  );
    ...
    >
      ...
      <div className="absolute top-8 left-8 right-8 flex justify-between z-10 pointer-events-none">
        <div className="w-96 h-20 bg-gray-900 border border-gray-700 rounded-md flex flex-col p-2">
          <div className="text-xs text-blue-400 font-mono mb-1">HAPPINESS LEVEL: ∞ 🥳🥳🥳</div>
        ...
        <div className="w-40 h-20 bg-gray-900 border border-gray-700 rounded-md flex flex-col justify-center items-center">
          <div className="text-xs text-blue-500 font-mono">-rutuuuu!!!💕</div>
          <motion.div
      ...
      >
        <div className="px-8 py-3 bg-gray-800/50 backdrop-blur-sm rounded-full border border-blue-500/30">
          <h1 className="text-2xl sm:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-blue-300 flex items-center gap-3">
            ...
            <span>🤍Cake o'clock Blessing🤍</span>
        ...
        {!isCut && (
          ...
          >
            ...
            >
              ...
              <span>every birthday starts with a wish... make yours!!!🌠</span>
              <Sparkles className="text-blue-300" size={18} />
            </motion.div>
          </motion.div>
        )}
        ...
        {cakeAnimationComplete && (
          ...
          >
            ...
            >
              ...
              >
                If you're smiling right now, then i've already got the best birthday gift in return!🤍
                <br />
                <span className="inline-flex items-center gap-1 mt-2">
                  Now come on dumbo...there's still something more waiting for youuu!💌 <Rocket size={16} className="text-blue-300" />
                </span>
              </motion.p>
            </motion.div>
