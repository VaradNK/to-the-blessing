...
import bgMusic from './music/tola-tola.mp3';
    ...
    >
      <div className="flex items-center space-x-3 p-2">
        ...
        <div className="flex-1">
          <h4 className="font-medium text-white text-sm truncate">Tola Tola</h4>
          <p className="text-indigo-200/80 text-xs">from Tu Hi Re</p>
...
export const Intro: React.FC<IntroProps> = ({ onComplete, audioRef, isMusicPlaying, setIsMusicPlaying }) => {
  ...
  const cosmicMessages = [
    "dumbooo...today is the day i've been manifesting to spend with you for so long...🤗",
    "and of course... we had to make it a little extra special!!🌻",
    "so here's a tiny space journey made just for youuu...enjoy every little bit of it!!!🫠",
  ];
  ...
  const handleUserReply = (replyText) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setMessages(prev => [...prev, { 
          sender: 'lessss goooo!', 
          text: "let's start the journey rutuuu baal...press on it🎶" 
        }]);
  ...
  const handleSongComplete = () => {
    ...
    const runSequence = async () => {
      ...
      await showMessage("okayyy... spaceship's all set! 🚀come with me...i've got a little universe full of surprises waiting just for youuu!!✨", 1000);
      
      // Second message
      await showMessage("to the stars!🚀", 1000);
          ...
          {!showFinalMessage ? (
            ...
            >
              ...
              <div className="p-4 border-b border-indigo-500/20 flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-indigo-100 font-medium">Happiest Birthday Myyy Dumboooo!!!🫶🏼</h3>
              ...
              <div className="p-4 border-t border-indigo-500/20">
                {showReplyOptions ? (
                  <div className="flex flex-wrap gap-2 justify-center">
                    {['hoho!🤭', 'ky kru me tuz varad?🤦🏻‍♀️', 'it will work out?!?!🤞🏼'].map((option) => (
                      <motion.button
                        key={option}
